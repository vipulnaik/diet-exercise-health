...
queries = [
    ...
    "select * from blood_pressure_readings where measurer = 'self' and not (systolic_bp_mm_hg - diastolic_bp_mm_hg between 27 and 50) and not (reading_date in ('2024-12-15'));",
    ...
    "select * from pulse_oximeter_readings where not (spo2_min between 92 and 100);",
