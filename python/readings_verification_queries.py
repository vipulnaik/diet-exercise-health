...
queries = [
    # Blood pressure
    "select * from blood_pressure_readings where reading_date > curdate();",
    ...
    # Pulse oximeter
    "select * from pulse_oximeter_readings where reading_date > curdate();",
    ...
    "select * from stethoscope_heart_rate_measurements where measurement_date > curdate();",
