...
queries = [
    ...
    "select * from food_preparations_and_openings where food_type = 'Red bell pepper' and quantity != 2 and not (preparation_or_opening_date in ('2024-09-08','2024-11-20','2025-01-01','2025-01-07','2025-06-22','2025-08-01','2025-08-03','2026-06-06','2026-06-26','2026-07-04','2026-08-07','2026-08-16','2026-09-13') or preparation_or_opening_date between '2025-04-10' and '2025-05-02');",
