...
queries = [
    ...
    select * from food_preparations_and_openings_self_join where (preparation_or_opening_date_2, meal_index_2) < (completion_date_1, completion_meal_index_1) and not (food_type in ('TJ Kale','Beefsteak tomato')) and not (
      ...
      (food_type = 'TJ Carrots' and preparation_or_opening_date_2 in ('2025-09-14','2026-04-20')) or
    ...
    "select * from food_preparations_and_openings where food_type = 'Red bell pepper' and quantity != 2 and not (preparation_or_opening_date in ('2024-09-08','2024-11-20','2025-01-01','2025-01-07','2025-06-22','2025-08-01','2025-08-03','2026-06-06') or preparation_or_opening_date between '2025-04-10' and '2025-05-02');",
