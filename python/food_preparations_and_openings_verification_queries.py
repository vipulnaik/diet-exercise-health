...
queries = [
    ...
    "select * from food_preparations_and_openings_self_join where preparation_or_opening_date_2 is null and not (completion_date_1 between '2025-05-03' and '2025-06-06') and datediff(curdate(), completion_date_1) > 1 and not (food_type in ('Whole Foods Mexican Whole Wheat Tortillas','Udupi Palace spinach masala dosa','Udupi Palace spinach masala dosa free red chutney','Lundberg Sustainable California White Jasmine Rice','Whole Foods Walnuts','TJ Green Lentils','TJ Kimchi','TJ Carrots (Organic)','Orange bell pepper'));",
