...
queries = [
    ...
    select * from food_preparations_and_openings_self_join where (preparation_or_opening_date_2, meal_index_2) < (completion_date_1, completion_meal_index_1) and not (food_type in ('TJ Kale','Beefsteak tomato')) and not (
      ...
      (food_type in ('Red bell pepper','Green bell pepper') and preparation_or_opening_date_2 in ('2025-08-03','2026-01-10','2026-01-14','2026-01-19')) or
    ...
    "select * from food_preparations_and_openings where food_type = 'Green bell pepper' and quantity != 4 and not (preparation_or_opening_date in ('2025-06-30','2025-08-01','2025-08-03','2026-01-10','2026-01-19'));",
