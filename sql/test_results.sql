...
insert into test_results(collection, test, units, reference_interval_low_end, reference_interval_high_end, measured_value, diagnosis, notes) values
  ...
  ('June 2021 Quest Diagnostics tests','EPA','percentage',0.2,2.3,0.5,'Normal','This was part of a set of omega-3 tests taken to provide a first baseline measurement after almost 1.5 years of supplementation. This measures eicosapentaenoic acid (EPA), one of the omega-3 fatty acids, as a percentage by weight.'),
  ('June 2021 Quest Diagnostics tests','DPA','percentage',0.8,1.8,0.8,'Normal','This was part of a set of omega-3 tests taken to provide a first baseline measurement after almost 1.5 years of supplementation. This measures docosapentaenoic acid (DPA), one of the omega-3 fatty acids, as a percentage by weight.'),
  ('June 2021 Quest Diagnostics tests','DHA','percentage',1.4,5.1,3.3,'Normal','This was part of a set of omega-3 tests taken to provide a first baseline measurement after almost 1.5 years of supplementation. This measures docosahexonic acid (DHA), one of the omega-3 fatty acids, as a percentage by weight.'),
  ('June 2021 Quest Diagnostics tests','Omega-6 total','percentage',NULL,NULL,40.2,NULL,'This was part of a set of omega-3 tests taken to provide a first baseline measurement after almost 1.5 years of supplementation. This measures the total across omega-6 fatty acids; omega-6 is used as a comparison/control for measuring omega-3, which is what the test is about. The two main omega-6 fatty acids are arachidonic acid and linoleic acid.'),
  ('June 2021 Quest Diagnostics tests','Arachidonic acid','percentage',8.6,15.6,9.8,'Normal','This was part of a set of omega-3 tests taken to provide a first baseline measurement after almost 1.5 years of supplementation. This measures arachidonic acid, one of the omega-6 fatty acids to which omega-3 fatty acids, and in particular EPA, are compared, as a percentage by weight.'),
  ('June 2021 Quest Diagnostics tests','Linoleic acid','percentage',18.6,29.5,28.1,'Normal','This was part of a set of omega-3 tests taken to provide a first baseline measurement after almost 1.5 years of supplementation. This measures linoleic acid, one of the omega-6 fatty acids to which omega-3 fatty acids are compared, as a percentage by weight.'),
