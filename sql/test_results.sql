...
insert into test_results(collection, test, units, reference_interval_low_end, reference_interval_high_end, measured_value, diagnosis, notes) values
  ...
  ('April 2024 Sutter Health blood tests','WBC','1000/uL',4,11,5.1,'Normal','This test was part of a complete blood count (CBC).'),
  ('April 2024 Sutter Health blood tests','RBC','100000/uL',4.4,6,4.93,'Normal','This test was part of a complete blood count (CBC).'),
  ('April 2024 Sutter Health blood tests','Hemoglobin','g/dL',13.5,18,15.1,'Normal','This test was part of a complete blood count (CBC).'),
  ('April 2024 Sutter Health blood tests','Hematocrit','%',40,52,45.6,'Normal','This test was part of a complete blood count (CBC).'),
  ('April 2024 Sutter Health blood tests','MCV','fL',80,100,93,'Normal','This test was part of a complete blood count (CBC).'),
  ('April 2024 Sutter Health blood tests','MCH','pg',27,33,30.6,'Normal','This test was part of a complete blood count (CBC).'),
  ('April 2024 Sutter Health blood tests','MCHC','g/dL',31,36,33.1,'Normal','This test was part of a complete blood count (CBC).'),
  ('April 2024 Sutter Health blood tests','RDW','%',0,16.4,12.5,'Normal','This test was part of a complete blood count (CBC).'),
  ('April 2024 Sutter Health blood tests','Platelets','1000/uL',150,400,242,'Normal','This test was part of a complete blood count (CBC).'),
  ('April 2024 Sutter Health blood tests','Neutrophils','%',NULL,NULL,67,'Normal','This test was part of a complete blood count (CBC).'),
  ('April 2024 Sutter Health blood tests','Lymphocytes','%',NULL,NULL,26,'Normal','This test was part of a complete blood count (CBC).'),
  ('April 2024 Sutter Health blood tests','Monocytes','%',NULL,NULL,6,'Normal','This test was part of a complete blood count (CBC).'),
  ('April 2024 Sutter Health blood tests','Eosinophils','%',NULL,NULL,1,'Normal','This test was part of a complete blood count (CBC).'),
  ('April 2024 Sutter Health blood tests','Basophils','%',NULL,NULL,0,'Normal','This test was part of a complete blood count (CBC).'),
  ('April 2024 Sutter Health blood tests','Neutrophils (absolute)','cells/uL',2000,8000,3300,'Normal','This test was part of a complete blood count (CBC). Note that the precision of results is only up to multiples of 100.'),
  ('April 2024 Sutter Health blood tests','Lymphocytes (absolute)','cells/uL',1000,5100,1300,'Normal','This test was part of a complete blood count (CBC). Note that the precision of results is only up to multiples of 100.'),
  ('April 2024 Sutter Health blood tests','Monocytes (absolute)','cells/uL',0,800,300,'Normal','This test was part of a complete blood count (CBC). Note that the precision of results is only up to multiples of 100.'),
  ('April 2024 Sutter Health blood tests','Eosinophils (absolute)','cells/uL',0,500,100,'Normal','This test was part of a complete blood count (CBC). Note that the precision of results is only up to multiples of 100.'),
  ('April 2024 Sutter Health blood tests','Basophils (absolute)','cells/uL',0,200,0,'Normal','This test was part of a complete blood count (CBC). Note that the precision of results is only up to multiples of 100.');
