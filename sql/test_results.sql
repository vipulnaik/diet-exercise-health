...
insert into test_results(collection, test, units, reference_interval_low_end, reference_interval_high_end, measured_value, diagnosis, notes) values
  ...
  ('April 2004 Dr. Lal lipid profile tests','Cholesterol HDL','mg/dL',30,60,28,'Below normal','This test was taken to provide an initial baseline for periodic measurement, in light of family diabetic tendencies.'),
  ...
  ('July 2004 Dr. Lal lipid profile tests','Cholesterol HDL','mg/dL',30,60,39,'Normal','This test was taken to provide a periodic measurement, in light of family diabetic tendencies.'),
  ...
  ('December 2004 Gokula Metropolis lipid profile tests','Cholesterol HDL','mg/dL',30,60,36,'Normal','This test was taken to provide a periodic measurement, in light of family diabetic tendencies.'),
  ...
  ('July 2005 Gokula Metropolis lipid profile tests','Cholesterol HDL','mg/dL',30,60,34,'Normal','This test was taken to provide a periodic measurement, in light of family diabetic tendencies.'),
  ...
  ('September 2005 Iravatham Chennai lipid profile tests','Cholesterol HDL','mg/dL',30,60,48,'Normal','This test was taken to provide a periodic measurement, in light of family diabetic tendencies.'),
  ...
  ('July 2006 SRL Bangalore lipid profile tests','Cholesterol HDL','mg/dL',30,60,41.4,'Normal','This test was taken to provide a periodic measurement, in light of family diabetic tendencies.'),
  ...
  ('July 2007 Gokula Metropolis lipid profile tests','Cholesterol HDL','mg/dL',30,60,35.6,'Normal','This test was taken to provide a periodic measurement, in light of family diabetic tendencies.'),
  ...
  ('July 2007 SRL Bangalore lipid profile tests','Cholesterol HDL','mg/dL',30,60,39,'Normal','This test was taken to provide a periodic measurement, in light of family diabetic tendencies.'),
  ...
  ('November 2017 Columbia Asia vitamin and lipid profile tests','Cholesterol HDL','mg/dL',30,60,51,'Normal','This test was taken to provide a periodic measurement, in light of family diabetic tendencies.'),
  ...
  ('June 2021 Quest Diagnostics tests','Cholesterol HDL','mg/dL',40,NULL,46,'Normal','This test was taken to provide a periodic measurement, in light of family diabetic tendencies and dyslipidemia issues.'),
  ...
  ('September 2024 Quest Diagnostics tests','Cholesterol HDL','mg/dL',40,NULL,46,'Normal','This test was taken to provide an updated periodic measurement, in light of family diabetic tendencies and dyslipidemia issues. The HDL cholesterol level was exactly the same as last time and above the threshold.'),
  ...
  ('April 2024 Sutter Health blood tests','Bilirubin total','mg/dL',0.1,1.3,0.6,'Normal','This test was part of a comprehensive metabolic panel. I had eaten 6.5 hours prior to the blood draw and then also had the citrus drink concoction right before the blood draw (for my urease breath test).'),
