...
insert into test_results(collection, test, units, reference_interval_low_end, reference_interval_high_end, measured_value, diagnosis, notes) values
  ...
  ('April 2024 Sutter Health blood tests','RBC','100000/uL',4.4,6,4.93,'Normal','This test was part of a complete blood count (CBC). I had eaten 6.5 hours prior to the blood draw and then also had the citrus drink concoction right before the blood draw (for my urease breath test).'),
  ...
  ('April 2024 Sutter Health blood tests','Neutrophils (absolute)','cells/uL',2000,8000,3300,'Normal','This test was part of a complete blood count (CBC). I had eaten 6.5 hours prior to the blood draw and then also had the citrus drink concoction right before the blood draw (for my urease breath test). Note that the precision of results is only up to multiples of 100.'),
  ('April 2024 Sutter Health blood tests','Lymphocytes (absolute)','cells/uL',1000,5100,1300,'Normal','This test was part of a complete blood count (CBC). I had eaten 6.5 hours prior to the blood draw and then also had the citrus drink concoction right before the blood draw (for my urease breath test). Note that the precision of results is only up to multiples of 100.'),
  ('April 2024 Sutter Health blood tests','Monocytes (absolute)','cells/uL',0,800,300,'Normal','This test was part of a complete blood count (CBC). I had eaten 6.5 hours prior to the blood draw and then also had the citrus drink concoction right before the blood draw (for my urease breath test). Note that the precision of results is only up to multiples of 100.'),
  ('April 2024 Sutter Health blood tests','Eosinophils (absolute)','cells/uL',0,500,100,'Normal','This test was part of a complete blood count (CBC). I had eaten 6.5 hours prior to the blood draw and then also had the citrus drink concoction right before the blood draw (for my urease breath test). Note that the precision of results is only up to multiples of 100.'),
  ('April 2024 Sutter Health blood tests','Basophils (absolute)','cells/uL',0,200,0,'Normal','This test was part of a complete blood count (CBC). I had eaten 6.5 hours prior to the blood draw and then also had the citrus drink concoction right before the blood draw (for my urease breath test). Note that the precision of results is only up to multiples of 100.'),
