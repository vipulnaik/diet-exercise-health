create table accidents(
  date date,
  cause_of_injury enum('Walking fall','Running fall','Traffic accident'),
...
insert into accidents(date, cause_of_injury, physical_injury_details, physical_injury_severity, other_damage_details, notes_doc) values
