insert into food_preparations_and_openings(preparation_or_opening_date, food_type, quantity) values
  ...
  ('2024-08-15','Gold potatoes 5 lb',0.53),
  ...
  ('2024-08-20','Gold potatoes 5 lb',0.53),
  ...
  ('2024-08-24','Gold potatoes 5 lb',0.53),
  ...
  ('2024-08-29','Gold potatoes 5 lb',0.53),
  ...
  ('2024-09-02','Gold potatoes 5 lb',0.53),
  ...
  ('2024-09-07','Gold potatoes 5 lb',0.53),
  ...
  ('2024-09-12','Gold potatoes 5 lb',0.53),
  ...
  ('2024-09-19','Gold potatoes 5 lb',0.53),
  ...
  ('2024-09-24','Gold potatoes 5 lb',0.53),
  ...
  ('2024-09-30','Gold potatoes 5 lb',0.53),
  ...
  ('2024-10-03','Gold potatoes 5 lb',0.53),
  ...
  ('2024-10-09','Gold potatoes 5 lb',0.53),
  ...
  ('2024-10-12','Wild Harvest Organic Lentils',0.53),
  /* New bottle/packet openings as the old ones finished */
  ...
  ('2024-10-14','Gold potatoes 5 lb',0.53),
  ...
  ('2024-10-15','Wild Harvest Organic Lentils',0.53),
  /* New bottle/packet openings as the old ones finished */
  ...
  ('2024-10-20','Gold potatoes 5 lb',0.53),
  ...
  ('2024-10-24','Gold potatoes 5 lb',0.53),
  ...
  ('2024-10-30','Gold potatoes 5 lb',0.53),
  ('2024-10-30','TJ Kale',1),
  ('2024-10-30','TJ English Shelled Peas',2),
  ('2024-10-30','Beefsteak tomato',6),
  /* New bottle/packet openings as the old ones finished */
  ('2024-11-01','TJ Almond Milk',1), /* first meal */
  ('2024-11-01','TJ Sauerkraut',1), /* first meal */
  /* Meal prep 2024-11-01 (second meal) */
  ('2024-11-01','Eggplant',1),
  ...
  /* New bottle/packet openings as the old ones finished */
  ('2024-11-01','Kite Hill Greek Style Plant-Based Yogurt',1), /* second meal */
  ('2024-11-01','TJ Carb Savvy Tortillas',1), /* second meal */
  /* Rice prep 2024-11-02 (second meal) */
  ('2024-11-02','Lundberg Sustainable California White Basmati Rice',0.8),
  /* New bottle/packet openings as the old ones finished */
  ('2024-11-02','TJ Miso Ginger Broth',1), /* second meal */
  ...
  ('2024-11-04','Gold potatoes 5 lb',0.53),
  ('2024-11-04','TJ Kale',1),
  ('2024-11-04','TJ English Shelled Peas',2),
  ('2024-11-04','Beefsteak tomato',6),
  /* New bottle/packet openings as the old ones finished */
  ('2024-11-04','TJ Roasted Seaweed',1), /* second meal */
  ('2024-11-05','TJ Walnuts',1), /* first meal */
  ...
  ('2024-11-07','Eggplant',1),
  ('2024-11-07','TJ Kale',1),
  ('2024-11-07','TJ Carrots',1),
  ('2024-11-07','Green bell pepper',4),
  ...
  ('2024-11-08','TJ Roasted Seaweed',1), /* second meal -- this is inferred / backfilled and the date may be off */
  /* Potatoes prep 2024-11-09 (first meal) */
  ('2024-11-09','Gold potatoes 5 lb',0.58),
  ('2024-11-09','TJ Kale',1),
  ('2024-11-09','TJ English Shelled Peas',2),
  ('2024-11-09','Beefsteak tomato',6),
  /* New bottle/packet openings as the old ones finished */
  ('2024-11-09','TJ Carb Savvy Tortillas',1), /* first meal */
  ('2024-11-09','Kite Hill Greek Style Plant-Based Yogurt',1), /* second meal */
  /* Rice prep 2024-11-10 (first meal) */
  ('2024-11-10','Lundberg Sustainable California White Basmati Rice',0.8),
  /* New bottle/packet openings as the old ones finished */
  ('2024-11-10','TJ Carb Savvy Tortillas',1), /* second meal */
  ('2024-11-11','TJ Miso Ginger Broth',1), /* first meal */
  ('2024-11-11','TJ Walnuts',1), /* first meal */
  ('2024-11-11','TJ Roasted Seaweed',1), /* second meal */
  ('2024-11-12','Kite Hill Greek Style Plant-Based Yogurt',1), /* first meal */
  ('2024-11-12','TJ Carb Savvy Tortillas',1), /* second meal */
  /* Potatoes prep 2024-11-13 (first meal) */
  ('2024-11-13','Gold potatoes 5 lb',0.45),
  ('2024-11-13','TJ Kale',1),
  ('2024-11-13','TJ English Shelled Peas',2),
  ('2024-11-13','Beefsteak tomato',6),
  /* New bottle/packet openings as the old ones finished */
  ('2024-11-13','TJ Carb Savvy Tortillas',1), /* first meal */
  /* Rice prep 2024-11-13 (second meal) */
  ('2024-11-13','Lundberg Sustainable California White Basmati Rice',0.8),
  /* Meal prep 2024-11-14 (first meal) */
  ('2024-11-14','Eggplant',1),
  ('2024-11-14','TJ Kale',1),
  ('2024-11-14','TJ Carrots',1),
  ('2024-11-14','Green bell pepper',4),
  ('2024-11-14','Red bell pepper',2),
  ('2024-11-14','Beefsteak tomato',6),
  /* New bottle/packet openings as the old ones finished */
  ('2024-11-14','Kite Hill Greek Style Plant-Based Yogurt',1), /* second meal */
  ...
  /* New bottle/packet openings as the old ones finished */
  ('2024-11-19','TJ Carb Savvy Tortillas',1), /* second meal */
  ('2024-11-19','California Walnuts',1), /* second meal */
  /* Rice prep 2024-11-20 (first meal) */
  ('2024-11-20','Lundberg Sustainable California White Basmati Rice',0.9),
  /* New bottle/packet openings as the old ones finished */
  ('2024-11-20','Kite Hill Greek Style Plant-Based Yogurt',1), /* first meal */
  /* Meal prep 2024-11-20 (second meal) */
  ('2024-11-20','Green bell pepper',4),
  ('2024-11-20','Red bell pepper',4),
  ('2024-11-20','TJ Kale',1),
  ('2024-11-20','TJ Carrots',1),
  ('2024-11-20','Beefsteak tomato',6),
  /* New bottle/packet openings as the old ones finished */
  ('2024-11-20','TJ Carb Savvy Tortillas',1), /* second meal */
  ('2024-11-20','TJ Miso Ginger Broth',1), /* second meal */
  /* Potatoes prep 2024-11-21 (second meal) */
  ('2024-11-21','Gold potatoes 5 lb',0.45),
  ...
  /* New bottle/packet openings as the old ones finished */
  ('2024-11-23','TJ Carb Savvy Tortillas',1), /* second meal */
  ...
  ('2024-11-28','Kite Hill Greek Style Plant-Based Yogurt',1), /* second meal */
  /* Potatoes prep 2024-11-29 (first meal) */
  ('2024-11-29','Gold potatoes 5 lb',0.45),
  ('2024-11-29','TJ Kale',1),
  ('2024-11-29','Beefsteak tomato',7),
  /* New bottle/packet openings as the old ones finished */
  ('2024-11-29','TJ Carb Savvy Tortillas',1), /* first meal */
  ('2024-11-30','TJ Carb Savvy Tortillas',1), /* first meal */
  /* Rice prep 2024-11-30 (second meal) */
  ('2024-11-30','Lundberg Sustainable California White Basmati Rice',0.9),
  /* New bottle/packet openings as the old ones finished */
  ('2024-11-30','Kite Hill Greek Style Plant-Based Yogurt',1), /* second meal */
  /* Lentils prep 2024-11-30 (overnight soaking to cook the next day) */
  ('2024-11-30','TJ Green Lentils',0.5),
  /* New bottle/packet openings as the old ones finished */
  ...
  /* New bottle/packet openings as the old ones finished */
  ('2024-12-02','TJ Carb Savvy Tortillas',1), /* first meal */
  ('2024-12-03','TJ Carb Savvy Tortillas',1), /* first meal */
  ('2024-12-03','Kite Hill Greek Style Plant-Based Yogurt',1), /* first meal */
  ...
  ('2024-12-03','Lundberg Sustainable California White Basmati Rice',0.9),
  /* New bottle/packet openings as the old ones finished */
  ('2024-12-03','TJ Roasted Seaweed',1), /* second meal */
  ('2024-12-04','TJ Miso Ginger Broth',1); /* first meal */
