...
insert into food_waste(waste_date, food_type, quantity, after_preparation_or_opening, notes) values
  ...
  ('2025-08-22','TJ Kimchi',0.6,true,'On Thursday 2025-08-21, when getting ready to eat the kimchi, I noticed that the kimchi had developed mold on it, so I stowed it back inside with the goal of throwing it away later. The next morning, Friday 2025-08-22, I took photos of the kimchi mold and then packed it to take out as trash. About 60% of the container was left at the time of discarding. My last record of kimchi consumption was 2025-08-10, though I might have consumed it one more time in between.'),
  ...
  ('2025-10-20','TJ Green Lentils',2,false,'I have not been cooking the green lentils for a while. Two packs hit their best by date on 2025-10-15, and I don''t intend to cook them for a while, so I decided to discard them.'),
  ...
  ('2026-03-10','TJ Green Lentils',1,false,'I have not been cooking the green lentils for a while. This was the last remaining packet (I had discarded two packets on 2025-10-20). This remaining packet had hit its best by date in January 2026, so I threw it out.'),
  ('2026-03-13','Beefsteak tomato',1,false,'This is a fudge factor entry so that the tomato stock matches up. It looks like I overcounted tomato purchases (unlikely because of tally checks) or undercounted tomato use by 1 somewhere between 2025-12-25 and 2026-03-13.'),
  ('2026-05-06','Udupi Palace spinach masala dosa free red chutney',1,false,'This was the free red chutney with the 2026-02-06 purchase. I didn''t get around to consuming it, partly due to the issues I had with the meal itself; see https://github.com/vipulnaik/diet-exercise-health/blob/master/events/2026/2026-02-06-onward-right-pelvic-discomfort.md for details. I decided to throw it out as it was already 3 months since purchase, and I wasn''t likely to eat it in the near future.');
