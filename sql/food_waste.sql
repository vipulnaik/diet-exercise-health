...
insert into food_waste(waste_date, food_type, quantity, notes) values
  ...
  ('2024-05-16','TJ Whole Wheat Lavash',0.22,'I had to throw out two out of the six pieces in one pack of lavash after it crossed its best by date as I had a negative reaction to the consumption of the rest of the lavash.'),
  ...
  ('2024-06-05','India House Oregon rice',0.3,'I threw out a little of the left-over rice as I didn''t feel like eating it.'),
  ('2024-06-05','India House Oregon aloo sag',0.3,'I threw out a little of the left-over aloo sag as I didn''t feel like eating it.'),
  ('2024-06-07','TJ Sauerkraut',0.6,'I left behind this sauerkraut in the hotel room in Portland as I wasn''t able to finish it and it seemed too messy to carry back.');
