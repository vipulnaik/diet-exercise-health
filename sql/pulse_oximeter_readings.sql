...
insert into pulse_oximeter_readings(reading_date, index_within_reading_date, finger, duration_in_seconds, heart_rate_min_bpm, heart_rate_max_bpm, spo2_min, spo2_max, notes) values
  ...
  /* 2024-07-23 */
  ('2024-07-23',2,'right index finger',60,54,58,98,98,'This reading was taken at night, shortly before getting ready for bed, at the start of a 15-minute relaxation period. I started looking at the measurement at 9:55:00 PM, about 30 seconds after putting the pulse oximeter in..');
