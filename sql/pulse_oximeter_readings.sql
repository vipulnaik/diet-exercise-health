...
insert into pulse_oximeter_readings(reading_date, index_within_reading_date, duration_in_seconds, heart_rate_min_bpm, heart_rate_max_bpm, spo2_min, spo2_max, notes) values
  /* 2024-07-13 */
