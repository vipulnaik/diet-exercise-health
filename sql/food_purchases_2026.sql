insert into food_purchases(purchase_date, food_type, quantity) values
  ...
  ('2026-02-06','TJ Carb Savvy Tortillas',5),
  ('2026-02-06','TJ Miso Ginger Broth',1),
  ('2026-02-06','TJ Kale',1),
  ('2026-02-06','TJ English Shelled Peas',2),
  ('2026-02-06','TJ Roasted Seaweed',1),
  ('2026-02-06','Beefsteak tomato',5), /* incorrectly billed as roma tomato */
  ...
  ('2026-02-09','TJ Almond Milk',1),
  ('2026-02-09','TJ Carb Savvy Tortillas',4),
  ('2026-02-09','Beefsteak tomato',5),
  ('2026-02-09','TJ Carrots',1),
  ('2026-02-09','TJ Sauerkraut',1),
  ('2026-02-09','Eggplant',1),
  ('2026-02-09','Green bell pepper',4),
  ('2026-02-09','Red bell pepper',2),
  ('2026-02-09','TJ Kale',1),
  ('2026-02-09','TJ Walnuts',2),
  ...
  ('2026-02-14','TJ Miso Ginger Broth',1),
  ('2026-02-14','TJ Almond Milk',1),
  ('2026-02-14','Beefsteak tomato',5),
  ('2026-02-14','TJ Kale',1),
  ('2026-02-14','TJ English Shelled Peas',2),
  ('2026-02-14','TJ Roasted Seaweed',1),
  ('2026-02-14','TJ Carb Savvy Tortillas',5), /* incorrectly billed as 4 */
  ...
  ('2026-02-20','Kite Hill Greek Style Plant-Based Yogurt',6),
  /* 2026-02-22 (Sunday) Trader Joe's; total cost $55.76; checkout at 2:22 PM; paid by credit card; 24 items in transaction */
  ('2026-02-22','TJ Carb Savvy Tortillas',3),
  ('2026-02-22','Eggplant',1),
  ('2026-02-22','Beefsteak tomato',5),
  ('2026-02-22','Red bell pepper',2),
  ('2026-02-22','Green bell pepper',4),
  ('2026-02-22','TJ Miso Ginger Broth',1),
  ('2026-02-22','TJ Turmeric',1),
  ('2026-02-22','TJ Carrots',1),
  ('2026-02-22','TJ Kale',1),
  ('2026-02-22','TJ Sauerkraut',2),
  ('2026-02-22','TJ Roasted Seaweed',1),
  ('2026-02-22','TJ Walnuts',2),
  /* 2026-02-25 (Wednesday) Trader Joe's; total cost $46.84; checkout at 8:04 PM; paid by credit card; 16 items in transaction */
  ('2026-02-25','TJ Miso Ginger Broth',1),
  ('2026-02-25','TJ English Shelled Peas',2),
  ('2026-02-25','TJ Roasted Seaweed',1),
  ('2026-02-25','TJ Carb Savvy Tortillas',6),
  ('2026-02-25','Gold potatoes 5 lb',1),
  ('2026-02-25','Beefsteak tomato',5),
  /* 2026-02-26 (Thursday) Trader Joe's; total cost $35.82; checkout at 7:50 PM; paid by credit card; 18 items in transaction */
  ('2026-02-26','TJ Almond Milk',1),
  ('2026-02-26','Green bell pepper',4),
  ('2026-02-26','TJ Carrots',1),
  ('2026-02-26','TJ Walnuts',2),
  ('2026-02-26','Red bell pepper',2),
  ('2026-02-26','Eggplant',1),
  ('2026-02-26','Beefsteak tomato',5),
  ('2026-02-26','TJ Kale',2),
  ...
  ('2026-03-01','Lundberg Sustainable California White Basmati Rice',2),
  ('2026-03-01','Lundberg Sustainable California White Jasmine Rice',2),
  ('2026-03-01','Kite Hill Greek Style Plant-Based Yogurt',5),
  /* 2026-03-03 (Tuesday) Trader Joe's; total cost $54.80; checkout at 8:01 PM; paid by credit card; 20 items in transaction */
  ('2026-03-03','TJ Carb Savvy Tortillas',6),
  ('2026-03-03','TJ Almond Milk',1),
  ('2026-03-03','TJ Kale',1),
  ('2026-03-03','TJ Miso Ginger Broth',1),
  ('2026-03-03','TJ Sauerkraut',1),
  ('2026-03-03','TJ English Shelled Peas',2),
  ('2026-03-03','Beefsteak tomato',8),
  ...
  ('2026-03-09','Lundberg Sustainable California White Jasmine Rice',3),
  ('2026-03-09','Kite Hill Greek Style Plant-Based Yogurt',5),
  /* 2026-03-10 (Tuesday) Trader Joe's; total cost $47.11; checkout at 8:05 PM; paid by debit card; 19 items in transaction */
  ('2026-03-10','Beefsteak tomato',6),
  ('2026-03-10','TJ Kale',1),
  ('2026-03-10','TJ Walnuts',4),
  ('2026-03-10','Green bell pepper',4),
  ('2026-03-10','TJ Sauerkraut',1),
  ('2026-03-10','Eggplant',1),
  ('2026-03-10','Red bell pepper',2),
  ...
  ('2026-03-14','Gold potatoes 5 lb',1),
  ('2026-03-14','TJ Kale',1),
  ('2026-03-14','TJ Roasted Seaweed',2),
  ('2026-03-14','Beefsteak tomato',8), /* I was billed for 7 as 6 + 1 */
  ('2026-03-14','TJ Carb Savvy Tortillas',3),
  ('2026-03-14','TJ English Shelled Peas',2),
  ...
  ('2026-03-17','Lundberg Sustainable California White Basmati Rice',1),
  ('2026-03-17','Lundberg Sustainable California White Jasmine Rice',2),
  ('2026-03-17','Morton Iodized Sea Salt',1),
  ('2026-03-17','Kite Hill Greek Style Plant-Based Yogurt',6);
