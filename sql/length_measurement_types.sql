...
insert into length_measurement_types(type_name, sided, notes) values
  ...
  ('vellus band width of central hairline',false,'This is a measure of the width (measured moving inferior to superior, or vertically) of the band of vellus hair as we encounter hair moving up from the glabella via the forehead.'),
  ('vellus band width of temple hairline',true,'This is a measure of the width (measured moving inferior to superior, or vertically) of the band of vellus hair as we encounter hair moving up from the outer edge of the eyebrow via the forehead.');
