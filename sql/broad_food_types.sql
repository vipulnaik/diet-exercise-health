...
insert into broad_food_types(broad_food_type, notes) values
  ...
  ('Whole wheat flatbread','Whole wheat in a form factor of a flatbread such as tortilla, roti, naan, or pita bread; rich in carbohydrates and proteins'),
  ('Non-whole wheat flatbread','Non-whole wheat in a form factor of a tortilla, roti, naan, or something similar; rich in carbohydrates and proteins'),
