...
insert into test_sample_collections(collection_slug, collection_date, sample_type, fasting, collection_lab, requester, notes, report_filename) values
  ...
  ('June 2021 Quest Diagnostics tests','2021-06-30','Blood',true,'Quest Diagnostics','Self (via Request A Test)','Several tests; see https://github.com/vipulnaik/diet-exercise-health/blob/master/events/2021/2021-blood-test-plans.md for more details.','202106-quest-diagnostics.pdf'),
