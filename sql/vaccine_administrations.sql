...
insert into vaccine_administrations(administration_slug, vaccine, location, administration_date, notes) values
  ...
  ('2021 Afluria influenza vaccine','Influenza','Walgreens (Gilman St), Berkeley','2021-11-05','Annual flu shot. Afluria shot in right arm. See https://github.com/vipulnaik/diet-exercise-health/blob/master/notes/2021-11-05-flu-shot.md for details.'),
  ('2021 COVID Pfizer vaccine booster dose','COVID','Walgreens (Gilman St), Berkeley','2021-12-24','Booster dose of COVID Pfizer, six months after the second dose. I experienced a slight fever that night and the next day; see https://github.com/vipulnaik/diet-exercise-health/blob/master/notes/2021-12-24-pfizer-covid-vaccine-booster-dose.md for details.'),
  ('2022 COVID Pfizer vaccine updated booster dose','COVID','Walgreens (Adeline St), Berkeley','2022-11-09','Updated booster dose of COVID Pfizer, almost a year after the original booster dose. See https://github.com/vipulnaik/diet-exercise-health/blob/master/notes/2022-11-09-pfizer-covid-vaccine-updated-booster-dose.md for notes.'),
  ('2022 Flucelvax influenza vaccine','Influenza','Walgreens (Adeline St), Berkeley','2022-11-26','Annual flu shot. Flucelvax shot in right arm. See https://github.com/vipulnaik/diet-exercise-health/blob/master/notes/2022-11-26-flu-shot.md for details.'),
  ('2023 Flucelvax influenza vaccine','Influenza','Walgreens (Adeline St), Berkeley','2023-10-13','Annual flu shot. Flucelvax shot in right arm. See https://github.com/vipulnaik/diet-exercise-health/blob/master/notes/2023-10-13-flu-shot.md for details.');
