insert into food_preparations_and_openings(preparation_or_opening_date, food_type, quantity, meal_index, completion_date, completion_meal_index) values
  ...
  ('2026-04-20','Gold potatoes 5 lb',0.5,2,null,null),
  ('2026-04-20','TJ Kale',1,2,null,null),
  ('2026-04-20','TJ Carrots',1,2,null,null),
  ('2026-04-20','Beefsteak tomato',3,2,null,null), /* limited by space in pot, not by tomato stock */
  /* new bottle/packet openings as the old ones finished */
  ...
  ('2026-04-23','Kite Hill Greek Style Plant-Based Yogurt',1,1,null,null),
