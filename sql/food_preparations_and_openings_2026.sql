insert into food_preparations_and_openings(preparation_or_opening_date, food_type, quantity, meal_index, completion_date, completion_meal_index) values
  ...
  /* new bottle/packet openings as the old ones finished */
  ('2026-01-12','TJ Cumin',1,1,'2026-06-15',2), /* opened with rice prep, completed with eggplant meal prep */
  ...
  /* new bottle/packet openings as the old ones finished */
  ('2026-02-21','TJ Turmeric',1,1,'2026-04-24',2), /* opened with rice prep */
  ...
  /* new bottle/packet openings as the old ones finished */
  ('2026-03-22','Trader Giotto''s Olive Oil',1,2,'2026-05-09',2),
  ...
  ('2026-03-29','Lundberg Sustainable California White Basmati Rice',1,2,'2026-04-02',2), /* completion date and meal index entered retrospectively and may be somewhat inaccurate */
  /* new bottle/packet openings as the old ones finished */
  ...
  ('2026-04-08','TJ Almond Milk',1,1,'2026-04-14',2),
  /* 2026-04-08 eggplant meal prep (second meal) (added olive oil, turmeric, cumin, cinnamon, cayenne pepper, and salt) */
  ('2026-04-08','Eggplant',1,2,'2026-04-12',2),
  ('2026-04-08','TJ Kale',1,2,'2026-04-12',2),
  ('2026-04-08','TJ Carrots',1,2,'2026-04-12',2),
  ('2026-04-08','Green bell pepper',4,2,'2026-04-12',2),
  ('2026-04-08','Red bell pepper',2,2,'2026-04-12',2),
  ('2026-04-08','Beefsteak tomato',7,2,'2026-04-12',2), /* checkpoint: stock down to 0 */
  /* new bottle/packet openings as the old ones finished */
  ('2026-04-08','TJ Walnuts',1,2,'2026-04-11',2),
  ('2026-04-09','TJ Sauerkraut',1,1,'2026-04-19',1),
  ...
  ('2026-04-10','Lundberg Sustainable California White Jasmine Rice',1,2,'2026-04-14',1),
  /* new bottle/packet openings as the old ones finished */
  ('2026-04-10','TJ Miso Ginger Broth',1,2,'2026-04-14',1),
  ('2026-04-10','TJ Roasted Seaweed',1,2,'2026-04-16',2), /* technically I had one sheet left by mistake, but I started consuming sheets from the next packet, so I just moved the remaining sheet to along with my rice for isolated consumption */
  ...
  ('2026-04-16','Eggplant',1,2,'2026-04-21',2),
  ('2026-04-16','TJ Kale',1,2,'2026-04-21',2),
  ('2026-04-16','TJ Carrots',1,2,'2026-04-21',2),
  ('2026-04-16','Green bell pepper',4,2,'2026-04-21',2),
  ('2026-04-16','Red bell pepper',2,2,'2026-04-21',2),
  ('2026-04-16','Beefsteak tomato',7,2,'2026-04-21',2),
  /* new bottle/packet openings as the old ones finished */
  ('2026-04-16','TJ Roasted Seaweed',1,2,'2026-04-23',2),
  ('2026-04-17','Kite Hill Greek Style Plant-Based Yogurt',1,1,'2026-04-18',2),
  /* 2026-04-18 rice prep (second meal) (added turmeric, cumin, salt) */
  ('2026-04-18','Lundberg Sustainable California White Jasmine Rice',1,2,'2026-04-21',2),
  /* new bottle/packet openings as the old ones finished */
  ...
  ('2026-04-20','TJ Sauerkraut',1,1,'2026-05-06',1), /* the greater-than-usual length is explained by the pause in between for dental cleaning */
  ...
  ('2026-04-20','TJ Kale',1,2,'2026-04-24',1),
  ('2026-04-20','TJ Carrots',1,2,'2026-04-24',1),
  ('2026-04-20','Beefsteak tomato',3,2,'2026-04-24',1), /* limited by space in pot, not by tomato stock */
  /* new bottle/packet openings as the old ones finished */
  ('2026-04-21','Kite Hill Greek Style Plant-Based Yogurt',1,2,'2026-04-23',1),
  /* 2026-04-22 rice prep (first meal) (added turmeric, cumin, salt) */
  ('2026-04-22','Lundberg Sustainable California White Basmati Rice',1,1,'2026-04-25',2),
  /* new bottle/packet openings as the old ones finished */
  ...
  ('2026-04-24','TJ Carrots',1,2,'2026-04-29',1),
  ('2026-04-24','Green bell pepper',4,2,'2026-04-29',1),
  ('2026-04-24','Red bell pepper',2,2,'2026-04-29',1),
  ('2026-04-24','Roma tomato',16,2,'2026-04-29',1),
  /* new bottle/packet openings as the old ones finished */
  ...
  ('2026-04-26','Lundberg Sustainable California White Jasmine Rice',1,1,'2026-04-29',1),
  /* new bottle/packet openings as the old ones finished */
  ('2026-04-26','TJ Turmeric',1,1,'2026-06-17',2), /* opened with 2026-04-26 rice prep, finished with 2026-06-17 rice prep */
  ('2026-04-26','Kite Hill Greek Style Plant-Based Yogurt',1,1,'2026-04-27',2),
  ('2026-04-26','TJ Walnuts',1,2,'2026-04-30',1),
  ('2026-04-28','Kite Hill Greek Style Plant-Based Yogurt',1,1,'2026-04-29',1),
  ('2026-04-28','TJ Almond Milk',1,1,'2026-05-03',2),
  ...
  ('2026-05-04','TJ Kale',1,2,'2026-05-07',2),
  ('2026-05-04','TJ Carrots',1,2,'2026-05-07',2),
  ('2026-05-04','Green bell pepper',4,2,'2026-05-07',2),
  ('2026-05-04','Red bell pepper',2,2,'2026-05-07',2),
  ('2026-05-04','Roma tomato',10,2,'2026-05-07',2),
  /* 2026-05-05 rice prep (first meal) (added turmeric, cumin, salt) */
  ('2026-05-05','Lundberg Sustainable California White Jasmine Rice',1,1,'2026-05-08',1),
  /* new bottle/packet openings as the old ones finished */
  ('2026-05-05','Kite Hill Greek Style Plant-Based Yogurt',1,1,'2026-05-06',2),
  ('2026-05-06','Kite Hill Greek Style Plant-Based Yogurt',1,2,'2026-05-08',1), /* stock down to 0 */
  ('2026-05-07','TJ Sauerkraut',1,1,'2026-05-22',1),
  /* 2026-05-07 potatoes prep (second meal) (added olive oil, turmeric, cumin, cinnamon, cayenne pepper, and salt) */
  ('2026-05-07','Gold potatoes 5 lb',0.5,2,'2026-05-11',2),
  ('2026-05-07','TJ Kale',1,2,'2026-05-11',2),
  ('2026-05-07','TJ English Shelled Peas',1.9,2,'2026-05-11',2),
  ('2026-05-07','Roma tomato',7,2,'2026-05-11',2),
  /* new bottle/packet openings as the old ones finished */
  ('2026-05-07','Ezekiel Sprouted Flourless Tortillas',1,2,'2026-05-08',2),
  ('2026-05-07','TJ Walnuts',1,2,'2026-05-10',2),
  ...
  ('2026-05-09','Eggplant',1,2,'2026-05-16',1),
  ('2026-05-09','TJ Kale',1,2,'2026-05-16',1),
  ('2026-05-09','TJ Carrots',1,2,'2026-05-16',1),
  ('2026-05-09','Green bell pepper',4,2,'2026-05-16',1),
  ('2026-05-09','Red bell pepper',2,2,'2026-05-16',1),
  ('2026-05-09','Roma tomato',3,2,'2026-05-16',1), /* stock down to 0 */
  ('2026-05-09','Beefsteak tomato',5,2,'2026-05-16',1),
  /* new bottle/packet openings as the old ones finished */
  ('2026-05-09','Kite Hill Greek Style Plant-Based Yogurt',1,2,'2026-05-11',1),
  ('2026-05-09','TJ Roasted Seaweed',1,2,'2026-05-17',2),
  /* 2026-05-10 rice prep (first meal) (added turmeric, cumin, salt) */
  ('2026-05-10','Lundberg Sustainable California White Jasmine Rice',1,1,'2026-05-13',1),
  /* new bottle/packet openings as the old ones finished */
  ('2026-05-10','TJ Miso Ginger Broth',1,1,'2026-05-17',1),
  ('2026-05-11','TJ Walnuts',1,1,'2026-05-14',1),
  ('2026-05-11','Kite Hill Greek Style Plant-Based Yogurt',1,1,'2026-05-12',1),
  ('2026-05-12','Kite Hill Greek Style Plant-Based Yogurt',1,2,'2026-05-13',2),
  /* 2026-05-13 rice prep (second meal) (added turmeric, cumin, salt) */
  ('2026-05-13','Lundberg Sustainable California White Basmati Rice',1,2,'2026-05-17',1),
  /* new bottle/packet openings as the old ones finished */
  ('2026-05-13','Kite Hill Greek Style Plant-Based Yogurt',1,2,'2026-05-14',2),
  ('2026-05-14','Ezekiel Sprouted Flourless Tortillas',1,1,'2026-05-16',1),
  /* 2026-05-14 potatoes prep (second meal) (added olive oil, turmeric, cumin, cinnamon, and salt -- forgot to add cayenne pepper which might be because of habit loss after recent skipping for various reasons) */
  ('2026-05-14','Gold potatoes 5 lb',0.5,2,'2026-05-19',1),
  ('2026-05-14','TJ Kale',1,2,'2026-05-19',1),
  ...
  ('2026-05-17','TJ Miso Ginger Broth',1,1,'2026-05-25',1),
  ('2026-05-17','Kite Hill Greek Style Plant-Based Yogurt',1,1,'2026-05-18',2),
  ...
  ('2026-05-20','TJ Almond Milk',1,1,'2026-05-28',1),
  ('2026-05-21','Ezekiel Sprouted Flourless Tortillas',1,1,'2026-05-22',2),
  /* 2026-05-22 rice prep (first meal) (added turmeric, cumin, salt) */
  ('2026-05-22','Lundberg Sustainable California White Basmati Rice',1,1,'2026-05-26',1),
  /* new bottle/packet openings as the old ones finished */
  ('2026-05-22','TJ Walnuts',1,1,'2026-05-25',2),
  ('2026-05-22','TJ Sauerkraut',1,1,'2026-06-04',1),
  ...
  ('2026-05-25','TJ Miso Ginger Broth',1,1,'2026-06-01',1),
  ('2026-05-25','TJ Roasted Seaweed',1,2,'2026-06-03',2),
  ('2026-05-25','Kite Hill Greek Style Plant-Based Yogurt',1,2,'2026-05-27',2),
  /* 2026-05-26 rice prep (first meal) (added turmeric, cumin, salt) */
  ('2026-05-26','Lundberg Sustainable California White Basmati Rice',1,1,'2026-05-29',2),
  /* new bottle/packet openings as the old ones finished */
  ('2026-05-26','TJ Walnuts',1,1,'2026-05-29',1),
  ('2026-05-28','Kite Hill Unsweetened Plain Almond Milk Yogurt',1,1,'2026-05-29',1),
  /* 2026-05-28 eggplant meal prep (second meal) (added olive oil, turmeric, cumin, cinnamon, cayenne pepper, and salt) */
  ('2026-05-28','Eggplant',1,2,'2026-06-04',2),
  ('2026-05-28','TJ Kale',1,2,'2026-06-04',2),
  ('2026-05-28','TJ Carrots',1,2,'2026-06-04',2),
  ('2026-05-28','Green bell pepper',4,2,'2026-06-04',2),
  ('2026-05-28','Red bell pepper',2,2,'2026-06-04',2),
  ('2026-05-28','Beefsteak tomato',7,2,'2026-06-04',2),
  /* new bottle/packet openings as the old ones finished */
  ('2026-05-28','TJ Almond Milk',1,2,'2026-06-05',1),
  ('2026-05-28','Ezekiel Sprouted Flourless Tortillas',1,2,'2026-05-30',1),
  ('2026-05-29','Kite Hill Greek Style Plant-Based Yogurt',1,1,'2026-05-30',2),
  ('2026-05-29','TJ Walnuts',1,2,'2026-06-02',1),
  /* 2026-05-30 rice prep (first meal) (added turmeric, cumin, salt) */
  ('2026-05-30','Lundberg Sustainable California White Basmati Rice',1,1,'2026-06-02',2),
  /* new bottle/packet openings as the old ones finished */
  ...
  ('2026-06-01','TJ Miso Ginger Broth',1,2,'2026-06-08',1),
  ('2026-06-02','TJ Walnuts',1,2,'2026-06-06',2),
  /* 2026-06-03 rice prep (first meal) (added turmeric, cumin, salt) */
  ...
  ('2026-06-06','Green bell pepper',4,1,'2026-06-11',2),
  ('2026-06-06','TJ Kale',1,1,'2026-06-11',2),
  ('2026-06-06','TJ Carrots',1,1,'2026-06-11',2),
  ('2026-06-06','Red bell pepper',4,1,'2026-06-11',2),
  ('2026-06-06','Beefsteak tomato',7,1,'2026-06-11',2),
  /* new bottle/packet openings as the old ones finished */
  ('2026-06-06','TJ Walnuts',1,2,'2026-06-10',1),
  /* 2026-06-07 rice prep (first meal) (added turmeric, cumin, salt) */
  ('2026-06-07','Lundberg Sustainable California White Basmati Rice',1,1,'2026-06-10',2),
  /* new bottle/packet openings as the old ones finished */
  ('2026-06-07','Kite Hill Greek Style Plant-Based Yogurt',1,2,'2026-06-09',2),
  ('2026-06-08','TJ Miso Ginger Broth',1,2,'2026-06-15',1),
  ('2026-06-09','Kite Hill Greek Style Plant-Based Yogurt',1,2,'2026-06-11',2),
  ...
  ('2026-06-11','TJ Roasted Seaweed',1,2,'2026-06-18',2),
  ...
  /* new bottle/packet openings as the old ones finished */
  ('2026-06-12','TJ Almond Milk',1,1,'2026-06-19',1),
  ...
  ('2026-06-15','Eggplant',1,2,'2026-06-22',1),
  ('2026-06-15','TJ Kale',1,2,'2026-06-22',1),
  ('2026-06-15','TJ Carrots',1,2,'2026-06-22',1),
  ('2026-06-15','Green bell pepper',4,2,'2026-06-22',1),
  ...
  /* new bottle/packet openings as the old ones finished */
  ('2026-06-17','TJ Cumin',1,2,'2026-09-13',1), /* opened with 2026-06-17 rice prep, finished with 2026-09-13 eggplant meal prep */
  ...
  ('2026-06-19','TJ Almond Milk',1,1,'2026-06-27',1),
  ('2026-06-19','TJ Roasted Seaweed',1,2,'2026-06-30',2),
  ...
  ('2026-06-22','Lundberg Sustainable California White Basmati Rice',1,2,'2026-06-26',2),
  /* new bottle/packet openings as the old ones finished */
  ('2026-06-23','TJ Walnuts',1,1,'2026-06-27',2),
  ('2026-06-23','Kite Hill Greek Style Plant-Based Yogurt',1,1,'2026-06-24',2),
  ...
  ('2026-06-25','Kite Hill Greek Style Plant-Based Yogurt',1,1,'2026-06-27',1),
  ...
  ('2026-06-26','Green bell pepper',4,1,'2026-07-04',2),
  ('2026-06-26','TJ Kale',1,1,'2026-07-04',2),
  ('2026-06-26','TJ Carrots',1,1,'2026-07-04',2),
  ('2026-06-26','Red bell pepper',4,1,'2026-07-04',2),
  ('2026-06-26','Beefsteak tomato',7,1,'2026-07-04',2),
  /* new bottle/packet openings as the old ones finished */
  ('2026-06-26','TJ Miso Ginger Broth',1,1,'2026-07-03',2),
  /* 2026-06-27 rice prep (first meal) (added turmeric, cumin, salt) */
  ('2026-06-27','Lundberg Sustainable California White Jasmine Rice',1,1,'2026-07-01',1),
  /* new bottle/packet openings as the old ones finished */
  ('2026-06-27','TJ Almond Milk',1,1,'2026-07-04',1),
  ('2026-06-27','Kite Hill Greek Style Plant-Based Yogurt',1,1,'2026-06-28',2),
  ('2026-06-27','TJ Walnuts',1,2,'2026-07-01',2),
  ...
  ('2026-07-04','TJ Kale',1,2,'2026-07-10',2),
  ('2026-07-04','TJ Carrots',1,2,'2026-07-10',2),
  ('2026-07-04','Red bell pepper',4,2,'2026-07-10',2),
  ('2026-07-04','Beefsteak tomato',7,2,'2026-07-10',2),
  /* new bottle/packet openings as the old ones finished */
  ('2026-07-04','Kite Hill Greek Style Plant-Based Yogurt',1,2,'2026-07-06',2),
  ...
  ('2026-07-07','TJ Sauerkraut',1,1,'2026-07-23',1),
  ('2026-07-08','Kite Hill Greek Style Plant-Based Yogurt',1,2,'2026-07-10',1),
  ('2026-07-08','TJ Roasted Seaweed',1,2,'2026-07-13',2),
  /* 2026-07-10 rice prep (first meal) (added turmeric, cumin, salt) */
  ('2026-07-10','Lundberg Sustainable California White Jasmine Rice',1,1,'2026-07-14',1),
  /* new bottle/packet openings as the old ones finished */
  ('2026-07-10','Kite Hill Greek Style Plant-Based Yogurt',1,1,'2026-07-11',2),
  ('2026-07-10','TJ Walnuts',1,2,'2026-07-14',1),
  ...
  ('2026-07-11','Gold potatoes 5 lb',0.47,1,'2026-07-15',1),
  ('2026-07-11','TJ Kale',1,1,'2026-07-15',1),
  ...
  ('2026-07-14','Lundberg Sustainable California White Jasmine Rice',1,2,'2026-07-19',1),
  /* new bottle/packet openings as the old ones finished */
  ...
  /* new bottle/packet openings as the old ones finished */
  ('2026-07-15','Kite Hill Greek Style Plant-Based Yogurt',1,2,'2026-07-17',1),
  /* one-off raw tomato consumption due to lack of cooked food */
  ...
  ('2026-07-16','Eggplant',1,2,'2026-07-23',1),
  ('2026-07-16','TJ Kale',1,2,'2026-07-23',1),
  ('2026-07-16','TJ Carrots',1,2,'2026-07-23',1),
  ('2026-07-16','Green bell pepper',4,2,'2026-07-23',1),
  ('2026-07-16','Red bell pepper',2,2,'2026-07-23',1),
  ('2026-07-16','Beefsteak tomato',8,2,'2026-07-23',1), /* stock down to 0; pot also full */
  /* new bottle/packet openings as the old ones finished */
  ('2026-07-17','Kite Hill Greek Style Plant-Based Yogurt',1,2,'2026-07-19',2),
  ('2026-07-18','TJ Almond Milk',1,1,'2026-07-26',2),
  ('2026-07-18','Ezekiel Sprouted Flourless Tortillas',1,1,'2026-07-20',1),
  ('2026-07-18','TJ Walnuts',1,2,'2026-07-22',1),
  /* 2026-07-19 rice prep (second meal) (added turmeric, cumin, salt) */
  ('2026-07-19','Lundberg Sustainable California White Basmati Rice',1,2,'2026-07-23',1),
  /* new bottle/packet openings as the old ones finished */
  ...
  ('2026-07-28','TJ Roasted Seaweed',1,2,'2026-08-08',2),
  ('2026-07-28','Ezekiel Sprouted Flourless Tortillas',1,2,'2026-07-30',1),
  /* 2026-07-29 rice prep (first meal) (added turmeric, cumin, salt) */
  ('2026-07-29','Lundberg Sustainable California White Basmati Rice',1,1,'2026-08-02',1),
  /* new bottle/packet openings as the old ones finished */
  ...
  ('2026-08-02','TJ Almond Milk',1,2,'2026-08-08',1),
  ...
  /* new bottle/packet openings as the old ones finished */
  ('2026-08-03','TJ Miso Ginger Broth',1,1,'2026-08-17',2),
  ('2026-08-03','Kite Hill Greek Style Plant-Based Yogurt',1,2,'2026-08-06',1),
  ('2026-08-05','TJ Walnuts',1,1,'2026-08-09',2),
  ('2026-08-06','Kite Hill Greek Style Plant-Based Yogurt',1,1,'2026-08-07',2),
  ('2026-08-06','Ezekiel Sprouted Flourless Tortillas',1,2,'2026-08-07',2),
  ...
  ('2026-08-07','Green bell pepper',4,1,'2026-08-14',1),
  ('2026-08-07','TJ Kale',1,1,'2026-08-14',1),
  ('2026-08-07','TJ Carrots',1,1,'2026-08-14',1),
  ('2026-08-07','Red bell pepper',4,1,'2026-08-14',1),
  ('2026-08-07','Beefsteak tomato',7,1,'2026-08-14',1), /* limited by space in pot; 3 of old stock, 4 of new stock, 3 remaining */
  /* new bottle/packet openings as the old ones finished */
  ...
  ('2026-08-18','Kite Hill Greek Style Plant-Based Yogurt',1,2,'2026-08-21',1), /* vanilla */
  ('2026-08-19','TJ Walnuts',1,1,'2026-08-22',1),
  ('2026-08-19','TJ Roasted Seaweed',1,2,'2026-08-26',2),
  ...
  ('2026-08-22','Beefsteak tomato',5,1,'2026-08-27',2), /* 2 from old batch, 3 from new batch, 1 from old batch thrown away due to spoilage, 4 remaining from new batch */
  /* new bottle/packet openings as the old ones finished */
  ...
  ('2026-08-29','TJ Almond Milk',1,1,'2026-09-06',1),
  ...
  /* new bottle/packet openings as the old ones finished */
  ('2026-08-30','TJ Sauerkraut',1,1,'2026-09-16',1),
  ...
  ('2026-08-31','Lundberg Sustainable California White Jasmine Rice',1,2,'2026-09-05',1),
  /* new bottle/packet openings as the old ones finished */
  ('2026-08-31','TJ Walnuts',1,2,'2026-09-05',1),
  ...
  ('2026-09-05','Lundberg Sustainable California White Basmati Rice',1,2,'2026-09-09',2),
  /* new bottle/packet openings as the old ones finished */
  ('2026-09-05','TJ Walnuts',1,2,'2026-09-09',1),
  ('2026-09-05','TJ Roasted Seaweed',1,2,'2026-09-18',2),
  ...
  ('2026-09-07','Gold potatoes 5 lb',0.5,2,'2026-09-13',1),
  ('2026-09-07','TJ Kale',1,2,'2026-09-13',1),
  ('2026-09-07','TJ English Shelled Peas',2,2,'2026-09-13',1),
  ('2026-09-07','Beefsteak tomato',3,2,'2026-09-13',1), /* 3 from old batch, discarded remaining 1 from old batch; I did not touch the new batch which has 7 tomatoes */
  /* new bottle/packet openings as the old ones finished */
  ...
  ('2026-09-10','Lundberg Sustainable California White Jasmine Rice',1,1,'2026-09-14',2),
  /* new bottle/packet openings as the old ones finished */
  ...
  /* new bottle/packet openings as the old ones finished */
  ('2026-09-13','TJ Almond Milk',1,2,'2026-09-21',1),
  ('2026-09-14','Ezekiel Sprouted Flourless Tortillas',1,1,'2026-09-15',2),
  ('2026-09-14','TJ Walnuts',1,2,'2026-09-19',1),
  ('2026-09-14','TJ Miso Ginger Broth',1,2,'2026-09-21',1),
  /* 2026-09-15 rice prep (first meal) (added turmeric, cumin, salt) */
  ('2026-09-15','Lundberg Sustainable California White Basmati Rice',1,1,'2026-09-19',1),
  /* new bottle/packet openings as the old ones finished */
  ...
  ('2026-09-18','Gold potatoes 5 lb',0.5,1,'2026-09-24',1),
  ('2026-09-18','TJ Kale',1,1,'2026-09-24',1),
  ('2026-09-18','TJ English Shelled Peas',2,1,'2026-09-24',1),
  ('2026-09-18','Beefsteak tomato',7,1,'2026-09-24',1), /* 5 from old batch (finishing old batch), 2 from new batch, 3 remain from new batch */
  /* new bottle/packet openings as the old ones finished */
  ...
  ('2026-09-21','Orange bell pepper',4,2,null,null),
  ('2026-09-21','Red bell pepper',4,2,null,null),
  ('2026-09-21','TJ Kale',1,2,null,null),
  ('2026-09-21','TJ Carrots',1,2,null,null),
  ...
  ('2026-09-23','Ezekiel Sprouted Flourless Tortillas',1,1,null,null),
