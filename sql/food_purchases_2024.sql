insert into food_purchases(purchase_date, food_type, quantity) values
  ...
  /* 2024-12-18 Trader Joe's; total cost $45.82; checkout at 6:52 PM; paid by credit card */
  ('2024-12-18','TJ Carb Savvy Tortillas',2),
  ('2024-12-18','Gold potatoes 5 lb',1),
  ('2024-12-18','Beefsteak tomato',10),
  ('2024-12-18','TJ Roasted Seaweed',1),
  ('2024-12-18','TJ Kale',1),
  ('2024-12-18','TJ Kimchi',1),
  ('2024-12-18','California Walnuts',2),
  /* 2024-12-18 Udupi Palace; total cost $14.28; paid by cash */
  ('2024-12-18','Udupi Palace spinach masala dosa',1),
  /* 2024-12-20 Trader Joe's; total cost $42.55; checkout at 5:32 PM; paid by credit card */
  ('2024-12-20','Eggplant',2),
  ('2024-12-20','TJ Carb Savvy Tortillas',3),
  ('2024-12-20','TJ Almond Milk',1),
  ('2024-12-20','TJ Miso Ginger Broth',1),
  ('2024-12-20','TJ Kale',2),
  ('2024-12-20','Beefsteak tomato',9),
  ('2024-12-20','Red bell pepper',2),
  ('2024-12-20','TJ Carrots',1),
  ('2024-12-20','Green bell pepper',4),
  /* 2024-12-22 Berkeley Bowl; total cost $62.90; checkout at 5:52 PM; paid by credit card */
  ('2024-12-22','Lundberg Sustainable California White Basmati Rice',4),
  ('2024-12-22','Kite Hill Greek Style Plant-Based Yogurt',6),
  /* 2024-12-26 Trader Joe's; total cost $66.82; checkout at 3:59 PM; paid by credit card */
  ('2024-12-26','TJ Carb Savvy Tortillas',4),
  ('2024-12-26','TJ Sauerkraut',1),
  ('2024-12-26','TJ Cumin',1),
  ('2024-12-26','TJ Turmeric',1),
  ('2024-12-26','TJ Carrots',1),
  ('2024-12-26','California Walnuts',3),
  ('2024-12-26','TJ Green Lentils',1),
  ('2024-12-26','Green bell pepper',4),
  ('2024-12-26','Red bell pepper',2),
  ('2024-12-26','Beefsteak tomato',9),
  ('2024-12-26','TJ Kale',1),
  /* 2024-12-28 Trader Joe's; total cost $32.43; checkout at 4:48 PM; paid by credit card */
  ('2024-12-28','Gold potatoes 5 lb',1),
  ('2024-12-28','TJ Carb Savvy Tortillas',2),
  ('2024-12-28','TJ Miso Ginger Broth',1),
  ('2024-12-28','TJ Kale',1), /* it was the tuscan kale rather than the regular one but it's the same size */
  ('2024-12-28','TJ Roasted Seaweed',1),
  ('2024-12-28','Beefsteak tomato',11),
  /* 2024-12-31 Trader Joe's; total cost $49.65; checkout at 4:26 PM; paid by debit card */
  ('2024-12-31','Red bell pepper',4), /* I was billed for 3 */
  ('2024-12-31','Beefsteak tomato',9),
  ('2024-12-31','California Walnuts',1),
  ('2024-12-31','TJ Carb Savvy Tortillas',5),
  ('2024-12-31','Green bell pepper',4),
  ('2024-12-31','TJ Carrots (Organic)',1),
  ('2024-12-31','TJ Kale',2);
