create table food_types(
  ...
  url varchar(200),
  consumption_mode enum('continuous primary','continuous with equal alternatives','continuous secondary','occasional','deprecated') default 'continuous primary',
  prepared_versus_opened enum('prepared','opened','microwaved','seasoning'),
...
insert into food_types(short_name, long_name, url,
  ...
  /* prepared versus opened */ prepared_versus_opened,
  ...
  /* consumption mode */ 'continuous primary',
  /* prepared versus opened */ 'opened',
  ...
  /* carbohydrate-related columns */ 16,8,8,
  ...
  /* consumption mode */ 'deprecated',
  /* prepared versus opened */ 'microwaved',
  ...
  /* consumption mode */ 'deprecated',
  /* prepared versus opened */ 'prepared',
  ...
  /* consumption mode */ 'continuous primary',
  /* prepared versus opened */ 'seasoning',
  ...
  /* consumption mode */ 'continuous secondary',
  /* prepared versus opened */ 'seasoning',
  /* calories, weight, and volume */ 0, 737, null,
  /* broad food type */ 'Table salt',
  /* fat-related columns */ 0,0,0,0,0,
  ...
  /* carbohydrate-related columns */ 16,8,4,
  ...
  /* broad food type */ 'Non-whole wheat flatbread',
  ...
  /* carbohydrate-related columns */ 90,60,0,
  ...
  /* consumption mode */ 'continuous with equal alternatives',
  /* prepared versus opened */ 'prepared',
  /* calories, weight, and volume */ 3200, 907, null,
  /* broad food type */ 'White rice',
  /* fat-related columns */ 10,0,0,null,null,
  ...
  ('India House Oregon rice','India House Oregon rice','https://nutrifox.com/nutrition/rice-white-steamed-chinese-restaurant',
  /* consumption mode */ 'occasional',
  /* prepared versus opened */ 'opened',
  /* calories, weight and volume */ 398,264,null,
  /* broad food type */ 'White rice',
  ...
  /* columns for other less commonly reported vitamins and minerals */ null,null,null,null,null,null,null,null,
  /* special oxalate column added in light of risk of kidney stones */ null,
  /* notes */ 'I had this for takeout on 2024-06-03 in Portland. For nutrition information, I took the estimates at the link https://nutrifox.com/nutrition/rice-white-steamed-chinese-restaurant and multiplied them by 2, and verified that it''s about 1/8 of the estimates from my raw rice packet that lasts me about 8 meals. I used rough RDA estimates for the numbers that were reported based on the RDA, I left out a few really small values (like vitamin B6) as not reliable.'),
  ...
  ('Wild Harvest Organic Lentils','Wild Harvest Organic Lentils','https://www.mywildharvest.com/our-products/product.organic-lentils-711535505730.html',
  /* consumption mode */ 'deprecated',
  /* prepared versus opened */ 'prepared',
  ...
  ('TJ Whole Wheat Pita Bread','Trader Joe''s Whole Wheat Pita Bread','https://world.openfoodfacts.org/product/00218009/whole-wheat-pita-bread-trader-joe-s',
  /* consumption mode */ 'deprecated',
  /* prepared versus opened */ 'opened',
  /* calories, weight, and volume */ 840,340,null,
  /* broad food type */ 'Whole wheat flatbread',
  /* fat-related columns */ 9,0,0,null,null,
  /* cholesterol */ 0,
  /* sodium and potassium (mostly from salts) */ 480,960,
  /* carbohydrate-related columns */ 180,30,0,
  /* protein-related columns */ 36,
  /* columns for commonly reported vitamins and minerals (other than sodium and potassium) */ null,null,0,120,9.6,
  /* columns for other less commonly reported vitamins and minerals */ null,null,null,null,null,null,null,null,
  /* special oxalate column added in light of risk of kidney stones */ null,
...
insert into food_types(short_name, long_name, url, consumption_mode, prepared_versus_opened, broad_food_type, notes) values
  ('Lemon','Lemon',null,'occasional','seasoning',null,'I just squeeze drops from the lemon rather than having the whole lemon, so any nutritional information for the whole lemon would be misleading.'),
  ('Himalayan Fine Pink Salt','Himalayan Fine Pink Salt',null,'occasional','seasoning','Table salt','I bought this as a one-off for saltwater rinsing for the Portland trip, so including it in nutritional information would be misleading.'),
  ('TJ Turmeric','Trader Joe''s Turmeric Powder 2 oz','https://www.amazon.com/Trader-Joes-Turmeric-2-Pack/dp/B00JU4BQ1Y','continuous primary','seasoning','Condiment','I use this turmeric powder for seasoning my prepared meals.'),
  ('TJ Cumin','Trader Joe''s Ground Cumin 1.7 oz','https://www.amazon.com/Trader-Joes-Ground-Cumin-NET/dp/B07G1BV593','continuous primary','seasoning','Condiment','I use this ground cumin for seasoning my prepared meals.'),
  ('TJ Cayenne Pepper','Trader Joe''s Cayenne Pepper','https://www.ebay.com/itm/175363234738','continuous primary','seasoning','Condiment','I use a little of this cayenne pepper as seasoning. It''s generally less in amount than the turmeric and cumin, and I might skip it in case of a sore throat.'),
  ('TJ Cinnamon','Trader Joe''s Ground Cinnamon','https://www.amazon.com/Trader-Joes-Ground-Cinnamon-Pack/dp/B07TH176BQ','continuous primary','seasoning','Condiment','I put a small amount of this as seasoning. I started using this as there was some left over in my group house. I also accidentally bought another bottle on 2023-08-11, so I may continue using it for some time.');

insert into food_types(short_name, long_name, consumption_mode, prepared_versus_opened, broad_food_type, notes) values
  /* pending data entry */
  ('Urban Platter Sauerkraut Raw','Urban Platter Sauerkraut Original Pickled Probiotic Cabbage, 450g / 15.8oz [Raw, Artisanal, Plant-Based, Preservative Free]','occasional','opened','Sauerkraut / Kimchi','Data at https://www.amazon.in/Urban-Platter-Sauerkraut-Original-Probiotic/dp/B07NC754H4/ but label is hard to read off fully; I should fill data in from the physical jar at some point. Just putting a dummy entry for now for validation.'),
  ('So Good Oat Milk 200 ml','So Good Oat Beverage Unsweetened 200ml','occasional','opened',null,'See https://www.amazon.in/So-Good-Beverage-Unsweetened-200ml/dp/B0D5BL419H/ for details'),
  ('So Good Soy Milk 200 ml','So Good Soy Beverage Unsweetened 200ml','occasional','opened','Soy milk','See https://www.amazon.in/So-Good-Beverage-Unsweetened-200ml/dp/B0D4ZFVYQ9/ for details'),
  /* Udupi Palace */
  ('Udupi Palace spinach masala dosa','Udupi Palace spinach masala dosa with sambhar and white chutney (not including free red chutney)','occasional','opened','Indian restaurant food','I generally order takeout for this when going to Trader Joe''s for grocery shopping.'),
  ('Udupi Palace spinach masala dosa free red chutney','Free red chutney that accompanies Udupi Palace spinach masala dosa','occasional','opened','Indian restaurant food','I am treating this as a separate item because I generally consume it separately after finishing the rest of the food'),
  ('Udupi Palace spring dosa','Udupi Palace spring dosa with sambhar, white chutney, and red chutney','occasional','opened','Indian restaurant food','I got this by mistake once when ordering the spinach masala dosa.'),
  ('Udupi Palace bisi bele bath','Udupi Palace bisi bele bath (dine-in) with papad, raita, and pickles','occasional','opened','Indian restaurant food','I generally have this dish when dining in at Udupi Palace.'),
  ('Udupi Palace sambhar','Udupi Palace sambhar','occasional','opened','Indian restaurant food','I sometimes order this as an extra dish when dining in at Udupi Palace.'),
  ('Udupi Palace sambhar (small)','Udupi Palace sambhar (small)','occasional','opened','Indian restaurant food','I sometimes order this as an extra dish when dining in at Udupi Palace.'),
  ('Udupi Palace medu vada','Udupi Palace medu vada','occasional','opened','Indian restaurant food','I had this once when dining in with a friend at Udupi Palace.'),
  /* Mehak Indian Cuisine */
  ('Mehak Indian Cuisine standard set','Mehak Indian Cuisine standard set: two colored rices (complementary), aloo gobi, aloo saag, vegetable masala, two dal soups','occasional','opened','Indian restaurant food','I used to get one takeout of this every 2-3 weeks from September 2020 to (approximately) May 2023. I stopped after switching to part-time work and adding potatoes to my home meal prep.'),
  ('Mehak Indian Cuisine chana masala','Mehak Indian Cuisine chana masala','occasional','opened','Indian restaurant food','I have occasionally ordered this as an additional dish in Mehak Indian Cuisine takeout, on top of my standard set.'),
  ('Mehak Indian Cuisine bengan bharta','Mehak Indian Cuisine bengan bharta','occasional','opened','Indian restaurant food','I have occasionally ordered this as an additional dish in Mehak Indian Cuisine takeout, on top of my standard set.'),
  ('Mehak Indian Cuisine dal soup','Mehak Indian Cuisine dal soup','occasional','opened','Indian restaurant food','The dal soup is part of my standard set (2 dal soups in a standard set) but I have on occasion ordered additional dal soups.'),
  /* Bangkok Thai Cuisine */
  ('Bangkok Thai Cuisine yellow curry tofu','Bangkok Thai Cuisine yellow curry tofu','occasional','opened','Thai restaurant food','I used to get this as takeout from Bangkok Thai Cuisine occasionally. I stopped after moving to a different part of town that was farther from the restaurant.'),
  /* Imm Thai Street Food */
  ('Imm Thai Street Food yellow curry tofu','Imm Thai Street Food yellow curry tofu','occasional','opened','Thai restaurant food','I get this as takeout sometimes, and have also had this as part of a dine-in at least once.'),
  ('Imm Thai Street Food spicy eggplant tofu','Imm Thai Street Food spicy eggplant tofu','occasional','opened','Thai restaurant food','I had this as part of a dine-in at least once.'),
  /* Pakwan */
  ('Pakwan meal set','Pakwan meal set (dal, chana aloo, aloo sag, mixed veg curry)','occasional','opened','Indian restaurant food','I sometimes order this meal combination when I''m on a trip to San Francisco and have time to order takeout from Pakwan.'),
  /* Tender Greens */
  ('Tender Greens happy vegan salad','Tender Greens happy vegan salad','occasional','opened','Healthy-marketed restaurant food','I occasionally visit Tender Greens for dine-in meals with others, and generally order the happy vegan salad during such meals.'),
  /* Revival Bar & Kitchen */
  ('Revival Bar & Kitchen paella','Revival Bar & Kitchen paella','occasional','opened','Uncategorized restaurant food','I had this dish at the end-of-year group dinner for the company I worked for at the time.'),
  /* Kitava */
  ('Kitava Power Bowl','Kitava Power Bowl','occasional','opened','Healthy-marketed restaurant food','I had this on 2023-11-29 when uenxpectedly dining in at Kitava.'),
  /* Tay Ho Oakland */
  ('Tay Ho Oakland Vegan Braised Eggplant, Tofu & Mushroom','Tay Ho Oakland Vegan Braised Eggplant, Tofu & Mushroom','occasional','opened','Vietnamese restaurant food','I had this on 2024-03-27 as part of lunch with work colleagues near the Oakland WeWork.'),
  /* India House Oregon */
  ('India House Oregon aloo sag','India House Oregon aloo sag','occasional','opened','Indian restaurant food','I had this for takeout on 2024-06-03 in Portland.'),
  ('Dil Se Indian Cuisine half chana masala and half aloo gobi','Dil Se Indian Cuisine half chana masala and half aloo gobi','occasional','opened','Indian restaurant food','I had this for takeout on 2024-06-04 in Portland.'),
  /* Asha Tea House */
  ('Asha Tea House ginger honey tea','Asha Tea House ginger honey tea','occasional','opened','Tea','I have this on the occasional visit to Asha Tea House, usually when meeting up with other people.'),
  /* We Be Sushi */
  ('We Be Sushi Vegetable Tempura','We Be Sushi Vegetable Tempura','occasional','opened','Japanese restaurant food','I had this once for a meal with work colleagues on Friday 2025-11-07.');
