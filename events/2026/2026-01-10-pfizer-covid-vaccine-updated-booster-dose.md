# 2026-01-10: Pfizer COVID vaccine updated booster dose
...
for Pfizer) on Sunday January 4. The appointment is for Saturday
January 10 at 3:30 PM at the 2801 Adeline Street location.

I followed the [best practices around vaccine
appointments](../../best-practices/best-practices-around-vaccine-appointments.md)
for the process. Since the appointment was for a Saturday, I did not
have to worry about conflicts with the day job.

### Initial booking with review of CDC guidance

The first time I booked was at around 3 PM. I did the booking and
filled the consent form. As part of the booking process, I read
through these five pages on the CDC website that were linked directly
or indirectly by Walgreens. These were to confirm my vaccine
eligibility.
...
* [Interim Clinical Considerations for Use of COVID-19 Vaccines in the
  United
  States](https://www.cdc.gov/covid/downloads/hcp/interim-clinical-considerations.pdf)
  (PDF with the most detailed version of the eligibility guidance)

The CDC guidance confirmed that the COVID-19 vaccine was still
allowed/recommended for me. The section that applied to me was "1d:
Ages 12–64 years" on Page 12 with the subcase "Previously vaccinated
before 2025–2026 vaccine" and the recommendation was "Administer 1
dose of 2025–2026 vaccine". For Pfizer, the recommendation was "At
least 8 weeks after last dose".

### Login gotcha

It turned out I was not logged in fully (Walgreens did show a "Hi,
Vipul" based on cookies when I was booking, which made me think I am
logged in. But it wasn't considered being logged in as far as the
vaccination-booking process is concerned, and nowhere during the
vaccination flow did it prod me to log in, so I did not realize at the
time.

I only noticed later in the vening when I logged in to my account and
could not find the appointment in the list. I re-booked at around 6:20
PM. This time, when booking, I was offered the option of booking using
my account versus as a guest, an option that I had not been given last
time.

To re-book at the same time, I needed to free up the vaccine slot from
my original booking, so I opened an incognito window where I was able
to access the appointment using the confirmation number, then canceled
it there. That freed up the slot and I was able to re-book the slot.

I confirmed after this second booking that the appointment showed up
in the list of appointments accessible to me when logged in. I also
received the appointment email with the new confirmation number.
...
* Check any vaccinations you've received in the past. Include a best
  ...
  * COVID-19 (SARS-CoV-2): 03/2025
    ([details](../2025/2025-03-21-pfizer-covid-vaccine-updated-booster-dose.md))

  * Herpes zoster (shingles): did not check

  * Influenza (flu): 11/2025 ([details](../2025/2025-11-08-flu-shot.md))

  * Pneumococcal (pneumonia): did not check

  * Respiratory syncytial virus (RSV): did not check

  * Tetanus, diphtheria, and pertussis (Tdap): 07/2024
    ([details](../2024/2024-07-12-tdap-vaccine-booster-dose.md))
...
* Do you have any chronic health condition(s), such as cancer, chronic
  ...
  sickle cell disease, diabetes, heart disease?

  Answer: No

After getting through the questions, I read the vaccine information
statement, scrolled through and clicked Accept on the consent, and got
through the signature page that was mostly pre-filled with details
from my account.

At the end, I got back to the appointment page with this banner on top:

> Consent forms completed. We look forward to seeing you soon!

#### Required forms gotcha

Even after I fill in the consent form, if I re-open the appointment to
manage it, it prompts me again to "Complete required forms". I did
this a second time and it still prompted me. There is no way to review
past filled answers.

## Preparation

### Calendar reminders and other upfront preparation

Following the best practices, I did the following; the end result was
a total of 12 calendar reminders on my personal calendar (1 shared
with work calendar) and 1 maintenance window:

* Vaccine appointment calendar reminder from 1 PM to 6 PM, starting
  2.5 hours prior and ending 2.5 hours after the appointment time. I
  also invited my work email address, though it's not that important
  since it's on a Saturday.

* Maintenance windows for work alerts for Saturday 2026-01-10 from
  9:30 AM to 8 PM ("start five hours prior to the appointment and end
  four hours after the end").

* Overrides for me: I'm not on any shared on-calls at the time, so
  nothing to do here!

* Work calendar events and Slack reminders: Nothing to do here!

* Shopping reminder for 2 days prior: I added a calendar reminder for
  Thursday 2026-01-08.

* Weather check reminder for 2 days prior: I added a calendar reminder
  for Thursday 2026-01-08.

* Pause and resume reminders for strength exercises and hand gripper
  exercises: I added the following calendar reminders:

  * Pause reminder on Thursday 2026-01-08 (2 days prior)

  * Resume reminder for hand gripper exercises with the left hand on
    Wednesday 2026-01-14 (4 days after)

  * Resume reminder for hand griper exercises with the right hand on
    Saturday 2026-01-17 (7 days after)

  * Resume reminder for strength exercises on Monday 2026-01-19 (9 days after)

* Reminder to update internal records 1 day after: I added a calendar
  reminder for Sunday 2026-01-11.

* Reminder to check and update copies of digital records 4 days after:
  I added a calendar reminder for Wednesday 2026-01-14.

* Reminder to pause jogging and breath holds on the morning of: I
  added a calendar reminder for the morning of Saturday 2026-01-10.

* Reminder to resume jogging and breath holds 3 days after: I added a
  calendar reminder for Tuesday 2026-01-13.
