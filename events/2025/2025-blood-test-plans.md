...
NOTE: I have removed from here the tests that I am covering in [round
1](2025-blood-test-plans-round-1.md) unless it makes sense to repeat
the tests.
...
* Own Your Labs: $92.40 (excluding Diabetes Risk Index)
* Marek Diagnostics: $84 plus $5 blood draw fee
* Request A Test: LabCorp: $225 (excluding GlycA and DRI), Quest Diagnostics: $233
